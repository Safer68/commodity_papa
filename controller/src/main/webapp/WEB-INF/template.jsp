...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/FortAwesome/Font-Awesome@5.6.3/css/all.min.css">
    <link rel="stylesheet" href="resources/assets/css/bootstrap.css">
    <link rel="stylesheet" href="resources/assets/css/theme.css">
    <link rel="stylesheet" href="resources/assets/css/excludable.css">
    ...
    <nav class="g-sidebar">
        ...
        <div class="g-sidebar__menu">
            <ul class="g-sidebar__menu-list">
                <li class="g-sidebar__menu-item">
                    <a class="g-sidebar__menu-link" href="#">
        ...
        <ul class="g-sidebar__footer">
            <li class="g-sidebar__footer-list">
                <a class="g-sidebar__footer-link" href="javascript:void(0)" data-toggle="tooltip" data-placement="top"
                   title="Settings">
...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.1.3/dist/css/bootstrap.min.css"
          ...
          crossorigin="anonymous">
    &lt;%&ndash;<link rel="stylesheet" href="${pageContext.request.contextPath}/WEB-INF/assets/css/bootstrap.css">&ndash;%&gt;
    <style>
        <%@include file="assets/css/theme.css"%>
        <%@include file="assets/css/excludable.css"%>
    </style>
    &lt;%&ndash; <link rel="stylesheet" href="${pageContext.request.contextPath}/WEB-INF/assets/css/theme.css">
     <link rel="stylesheet" href="${pageContext.request.contextPath}/WEB-INF/assets/css/excludable.css">&ndash;%&gt;
...
<div class="g-navigation">
    ...
    &lt;%&ndash;<c:import url="sidebar.jsp"/>&ndash;%&gt;
    &lt;%&ndash;@@include('./header/header.html')
    @@include('./sidebar/sidebar.html')&ndash;%&gt;
    <nav class="g-sidebar">
        <div class="g-sidebar__profile container d-flex active align-items-center">
            <img class="g-sidebar__profile-photo rounded-circle img-fluid"
                 src="https://avatars3.githubusercontent.com/u/1621344?s=460&v=4"/>
...
&lt;%&ndash;<c:import url="partials/navigation.jsp"/>&ndash;%&gt;
&lt;%&ndash;@@include('./../partials/navigation/navigation.html')&ndash;%&gt;
                ...
                <span class="g-list">
                  ...
                  <i class="g-list__bullet text-warning"></i> Spam (2 - 18%)
                        ...
                        <div class="g-status-box__donut">
                            <canvas id="inquiries-chart" height="60px" width="60px"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <section class="g-section">
                    ...
                    <div class="g-activity">
                        <div class="g-activity__item">
                            <a href="#"><strong>Lisy Huang</strong></a> created a new article: <a
                                href="https://disure.co/blogs/news/4-hard-things-i-learned-after-the-first-2-weeks-of-entrepreneurship"
                                target="_blank"><strong>4 Hard Things I Learned After the First 2 Weeks of
                            Entrepreneurship</strong></a>.
                            <div class="g-activity__time">10 mins ago</div>
                        </div>
                        <div class="g-activity__item">
                            <a href="#"><strong>Lisy Huang</strong></a> created a new product: <strong><a
                                href="https://disure.co/products/rest-apig-rest-a-pig-3-styles" target="_blank">REST
                            APIG/Rest a Pig T-Shirt</a></strong>.
                            <div class="g-activity__time">1 hour ago</div>
                        </div>
                        <div class="g-activity__item">
                            <a href="#"><strong>Lisy Huang</strong></a> created a new collection: <strong><a
                                href="https://disure.co/collections/boba-tea" target="_blank">Boba Tea
                            Lover</a></strong>.
                            <div class="g-activity__time">1 day ago</div>
                        </div>
                        <div class="g-activity__item">
                            <a href="#"><strong>Christian Esperar</strong></a> created a new article: <a
                                href="https://disure.co/blogs/news/4-personality-traits-of-boba-tea-bubble-tea-lovers"
                                target="_blank"><strong>4 Personality Traits of Boba Tea (Bubble Tea)
                            Lovers</strong></a>.
                            <div class="g-activity__time">15 days ago</div>
                        </div>
                        <div class="g-activity__item">
                            <a href="#"><strong>Lisy Huang</strong></a> created a new product: <strong><a
                                href="https://disure.co/products/be-a-catnicorn-t-shirt-3-styles" target="_blank">Be a
                            Catnicorn T-shirt</a></strong>.
...
&lt;%&ndash;@@include('./../partials/footer/footer.html')
@@include('./../partials/scripts.html')&ndash;%&gt;
