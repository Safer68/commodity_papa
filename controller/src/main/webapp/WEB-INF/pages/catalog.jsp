...
<div class="row">
    <div class="col-12">
        <h1>Каталог<span class="g-main__subtitle"></span></h1>
    </div>
    <div class="row">
        <div class='d-flex justify-content-start'>
            <button class="dropdown-item js-course-detail"
                ...
                <i class="bi bi-plus-square">&nbsp&nbspДобавить продукт</i>
            </button>
        </div>
    </div>
</div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="g-notification dropdown-menu dropdown-menu-right">
                                    ...
                                    <form action="${pageContext.request.contextPath}/managerPage?pageName=Catalog" name="deleting"
                                          method="post">
